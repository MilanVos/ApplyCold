...
public class KillConfirmationGui {
    ...
    private void setupGui(){
        ...
        ItemStack confirmItem = createItem(Material.LIME_CONCRETE, "§a§lCONFIRM", "§7Click to confirm killing yourself", "§c§lWARNING: This will kill you!");
        ...
        ItemStack skullItem = createItem(Material.PLAYER_HEAD, "§6§l" + player.getName(), "§7Are you sure you want to kill yourself?", "§7This action cannot be undone!");
